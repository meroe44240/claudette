...
const SourcingKalentPage = lazy(() => import('./pages/sourcing/index'));
    ...
    <Suspense fallback={<PageLoader />}>
      <Routes>
        ...
        >
          ...
          <Route path="sourcing" element={<SourcingKalentPage />} />
          ...
          <Route path="mandats/kanban" element={<MandatsLifecycleKanbanPage />} />
