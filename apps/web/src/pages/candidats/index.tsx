...
// ── Avatar helpers ──────────────────────────────────────────────
const AVATAR_BG = ['#22177A','#10B981','#F59E0B','#3B82F6','#EC4899','#14B8A6','#8B5CF6','#EF4444'];
...
export default function CandidatsPage() {
  ...
  return (
    <div>
      {/* Header mock-fidelity : h1 38px Archivo Black + count pill + view toggle + Ajouter primary */}
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 20, marginBottom: 24 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <button
            onClick={() => navigate('/candidats/new')}
